...
@section('content')
    ...
    <!-- 1️⃣ Hero Section -->
    <div
        class="service-banner flex flex-col md:flex-row justify-between px-4 sm:px-6 md:px-12 py-6 sm:py-8 md:py-12 relative overflow-hidden">
        <!-- Left Content -->
        <div class="relative z-10 md:w-1/2 text-white flex flex-col justify-center pl-4 sm:pl-6 md:pl-12">
            ...
            <h4 class="text-sm sm:text-base md:text-lg leading-relaxed">
                ...
                Our skilled team ensures accuracy, efficiency, and professionalism so you can focus on scaling your
                business.
            </h4>
        </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            document.querySelectorAll('.floating-services .service').forEach(function(item) {
